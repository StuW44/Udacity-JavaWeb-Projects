...
public class CarService {
    ...
    public CarService(CarRepository repository,
        ...
        this.pricingClient = new PriceClient(pricing);
        this.mapper = mapper;
    ...
    public List<Car> list() {
        ...
        List<Car> cars=repository.findAll();
            cars.forEach(
                carToBeUpdated-> {
                    carToBeUpdated.setPrice(pricingClient.getPrice(carToBeUpdated.getId()));
    ...
    public Car findById(Long id) {
         ...
         */
        String carprice=pricingClient.getPrice(car.getId());
